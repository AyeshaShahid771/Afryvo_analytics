  ...
  return (
    <header>
      <nav
        ...
        className="fixed z-20 w-full left-0 right-0 px-2 sm:px-4"
      >
        <div
          className={cn(
        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-4 sm:gap-6 py-2.5 sm:py-3 lg:gap-0 lg:py-4">
